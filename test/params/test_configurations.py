...
class TestConfigurationsISAString(TestCase):
    ...
    TEST_CASES = [
        ISAStrTest(
            ...
            "rv32imzicsr_zifencei_svinval_xintmachinemode_xintsupervisor",
            "rv32imzicsr_zifencei_svinval_xintmachinemode_xintsupervisor",
            "rv32imzicsr_zifencei_svinval_xintmachinemode_xintsupervisor",
        ),
        ISAStrTest(
            configurations.small_linux,
            "rv32imazicsr_zifencei_svinval_xintmachinemode_xintsupervisor",
            "rv32imazicsr_zifencei_svinval_xintmachinemode_xintsupervisor",
            "rv32imazicsr_zifencei_svinval_xintmachinemode_xintsupervisor",
        ),
        ISAStrTest(
            configurations.full,
            "rv32imacbzicond_zicsr_zifencei_zcb_zbc_zbkx_svinval_xintmachinemode_xintsupervisor",
            "rv32imacbzicond_zicsr_zifencei_zcb_zbc_zbkx_svinval_xintmachinemode_xintsupervisor",
            "rv32imacbzicond_zicsr_zifencei_zcb_zbc_zbkx_svinval_xintmachinemode_xintsupervisor",
        ),
